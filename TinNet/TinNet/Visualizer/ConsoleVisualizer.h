...
#ifndef _CLASS_TINNET_VISUALIZER_CONSOLE_VISUALIZER_H

#define _CLASS_TINNET_VISUALIZER_CONSOLE_VISUALIZER_H
...
namespace TinNet::Visualizer
{
	...
	class TINNET_DLL ConsoleVisualizer final
	{
	public:
