...
#ifndef _CLASS_CAYSNET_OPTIMIZER_SUPERVISED_SUPERVISEDOPTIMIZERBASE_H

#define _CLASS_CAYSNET_OPTIMIZER_SUPERVISED_SUPERVISEDOPTIMIZERBASE_H
...
{
	class CAYSNET_DLL SupervisedOptimizerBase
	{
	protected:
		NN &sNN;
