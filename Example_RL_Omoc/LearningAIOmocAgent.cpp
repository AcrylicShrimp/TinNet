...
{
	LearningAIOmocAgent::LearningAIOmocAgent(TinNet::NN *pNewNetwork, TinNet::Optimizer::MonteCarloPolicyGradient &sNewUpdater) :
	...
	void LearningAIOmocAgent::handlePlaceOK(int nPlace)
	{
		this->sEpList.sState.emplace_back(this->pPlace, this->pPlace + 81);
		this->sEpList.sAction.emplace_back(81u, .0f);
		this->sEpList.sReward.emplace_back(.5f);
